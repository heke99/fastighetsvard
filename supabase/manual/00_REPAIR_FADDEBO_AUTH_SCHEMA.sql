-- =============================================================================
-- STEG 1 AV 2: REPARERA FADDEBOS AUTH- OCH KONTO-SCHEMA
-- =============================================================================
-- Kör hela filen i Supabase Dashboard -> SQL Editor INNAN du skapar ägaren.
-- Den kräver inte `supabase link` och kan köras flera gånger.
-- =============================================================================
